...
<br><br><br>
    <?php
       $form = ActiveForm::begin([
          'layout' => 'horizontal',
          'action' => ['detail-kuis/latihan-student'],
          'method' => 'get',
          'fieldConfig' => [
              'template' => "{label}\n{beginWrapper}\n{input}\n{error}\n{endWrapper}\n{hint}",
    ...
    <?= $form->field($model, 'kuis_name',['horizontalCssClasses' => ['wrapper' => 'col-sm-6']])
    ...
    <div class="form-group">
        <div class="col-md-1 col-md-offset-4"></div>
            ...
            <?= Html::resetButton('<i class="fa fa-refresh"></i> Ulang', ['class' => 'btn btn-success']) ?>
    </div>
