<?php	
	...
	$this->title = 'Bahan Bacaan | Web';
?>


<div class="all-title-box">
	<div class="container text-center">
		<h1>Materi<span class="m_1">Temukan Hal Baru Untuk Memperluas Wawasan Kamu</span></h1>
	</div>
</div>
...
<div class="container">
    ...
    <h1 class="title text-center">Mata <span>Pelajaran</span></h1>
   	<br>
    <p>
        <!-- <?= Html::a('<i class="fa fa-plus-circle fa-4x"></i> Tambah Mata Pelajaran<br>', ['/mapel/create'], ['class' => 'btn btn-create']) ?> -->
    </p>
			...
			<div class="image-box">
				<div class="overlay-container">
					<img src="/WebPKM2018/frontend/web/worthy/images/<?php echo $mapel.".png";?>">
						<?php echo "<a class='overlay' href='".Url::toRoute(['topik-by-guru', 'id' => $value->mapel_id])."'>".$value->nama_mapel; ?>
