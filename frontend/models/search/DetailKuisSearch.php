...
/**
 * DetailKuisSearch represents the model behind the search form about `frontend\models\DetailKuis`.
 */
class DetailKuisSearch extends DetailKuis
{
    ...
    {
        return [
            [['detail_kuis_id', 'kuis_id', 'no_soal', 'created_at', 'updated_at'], 'integer'],
            [['pertanyaan', 'jawaban_benar', 'opsi_a', 'opsi_b', 'opsi_c', 'opsi_d', 'opsi_e', 'penyelesaian_file', 'penyelesaian_video'], 'safe'],
        ];
    }
